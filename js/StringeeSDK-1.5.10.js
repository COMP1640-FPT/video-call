...
function StringeeClient() {
    this.socket = null, this._stringeeServerAddr = "https://v1.stringee.com:6888", this._currentRequestId = 1, this._callbacks = new StringeeHashMap, this.accessToken = "", this._onMethods = new StringeeHashMap, this._stringeeCalls = [], this.deviceId = "web-" + this._genUuid(), this.browserId = localStorage.getItem("stringee_browser_id"), this.browserId || (this.browserId = "browser-" + this._genUuid(), localStorage.setItem("stringee_browser_id", this.browserId)), this.sessionId = "session-" + this._genUuid()
}

function StringeeCall(e, t, r, n) {
    this.client = e, this.fromNumber = t, this.toNumber = r, this.custom = "", this.customDataFromYourServer = "", this.fromAlias = t, this.toAlias = r, this.fromInternal = !0, this.answeredOnAnotherDevice = !1, this.isVideoCall = n, this.isIncomingCall = !1, this.isAnswered = !1, this.isOnHold = !1, this.ended = !1, this.callId = "", this._iceServers = null, this.toType = "", this.muted = !1, this.localVideoEnabled = n, this._onMethods = new StringeeHashMap, e._stringeeCalls.push(this), this.videoResolution = null, this._pc = null, this._localStream = null, this._remoteStream = null, this._localSdp = null, this._remoteSdps = new StringeeHashMap, this._mapListCandidates = new StringeeHashMap, this._answeredDeviceId = null, this._setRemoteSdpOk = !1, this._mediaConnected = !1
}
    ...
    return function e(t, r, n) {
        ...
        1: [function (e, t, r) {
            ...
            function i(e, t, r, n, i) {
                ...
                if (o += p.writeIceParameters(e.iceGatherer.getLocalParameters()), o += p.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : i || "active"), o += "a=mid:" + e.mid + "\r\n", e.rtpSender && e.rtpReceiver ? o += "a=sendrecv\r\n" : e.rtpSender ? o += "a=sendonly\r\n" : e.rtpReceiver ? o += "a=recvonly\r\n" : o += "a=inactive\r\n", e.rtpSender) {
            ...
            function a(e, t) {
                var r = {codecs: [], headerExtensions: [], fecMechanisms: []}, n = function (e, t) {
                    ...
                    var o = n(e.parameters.apt, r), a = n(t.parameters.apt, i);
                ...
                return e.codecs.forEach(function (n) {
                    for (var o = 0; o < t.codecs.length; o++) {
                        ...
                        if (n.name.toLowerCase() === a.name.toLowerCase() && n.clockRate === a.clockRate) {
                            ...
                            a = JSON.parse(JSON.stringify(a)), a.numChannels = Math.min(n.numChannels, a.numChannels), r.codecs.push(a), a.rtcpFeedback = a.rtcpFeedback.filter(function (e) {
            ...
            t.exports = function (e, t) {
                ...
                var f = function (r) {
                    ...
                    if (r.iceServers = o(r.iceServers || [], t), this._iceGatherers = [], r.iceCandidatePoolSize) for (var a = r.iceCandidatePoolSize; a > 0; a--) this._iceGatherers.push(new e.RTCIceGatherer({
                ...
                Object.defineProperty(f.prototype, "localDescription", {
                    ...
                    for (var n, i = 0; i < this.transceivers.length; i++) this.transceivers[i].track || this.transceivers[i].kind !== t.kind || (n = this.transceivers[i]);
                    ...
                    var n = this, i = this.transceivers[r].iceGatherer;
                    if (!i.onlocalcandidate) {
                        ...
                        this.transceivers[r].bufferedCandidateEvents = null, i.removeEventListener("localcandidate", this.transceivers[r].bufferCandidates), i.onlocalcandidate = function (e) {
                            if (!(n.usingBundle && r > 0)) {
                                ...
                                var a = e.candidate, s = !a || 0 === Object.keys(a).length;
                                if (s) "new" !== i.state && "gathering" !== i.state || (i.state = "completed"); else {
                                    "new" === i.state && (i.state = "gathering"), a.component = 1, a.ufrag = i.getLocalParameters().usernameFragment;
                                    var c = p.writeCandidate(a);
                                    o.candidate = Object.assign(o.candidate, p.parseCandidate(c)), o.candidate.candidate = c, o.candidate.toJSON = function () {
                                        return {
                                ...
                                d[o.candidate.sdpMLineIndex] += s ? "a=end-of-candidates\r\n" : "a=" + o.candidate.candidate + "\r\n", n._localDescription.sdp = p.getDescription(n._localDescription.sdp) + d.join("");
                                var l = n.transceivers.every(function (e) {
                                    return e.iceGatherer && "completed" === e.iceGatherer.state
                                });
                                "gathering" !== n.iceGatheringState && (n.iceGatheringState = "gathering", n._emitGatheringStateChange()), s || n._dispatchEvent("icecandidate", o), l && (n._dispatchEvent("icecandidate", new Event("icecandidate")), n.iceGatheringState = "complete", n._emitGatheringStateChange())
                            }
                    ...
                    r && e.rtpSender && (i.encodings = e.sendEncodingParameters, i.rtcp = {
                        ...
                        delete e.rtx
                    }), e.recvEncodingParameters.length ? i.encodings = e.recvEncodingParameters : i.encodings = [{}], i.rtcp = {compound: e.rtcpParameters.compound}, e.rtcpParameters.cname && (i.rtcp.cname = e.rtcpParameters.cname), e.sendEncodingParameters.length && (i.rtcp.ssrc = e.sendEncodingParameters[0].ssrc), e.rtpReceiver.receive(i))
                    ...
                    var r, n;
                    if ("offer" === e.type) r = p.splitSections(e.sdp), n = r.shift(), r.forEach(function (e, r) {
                        ...
                        r.forEach(function (e, r) {
                            var o = t.transceivers[r], s = o.iceGatherer, c = o.iceTransport, d = o.dtlsTransport,
                                l = o.localCapabilities, u = o.remoteCapabilities;
                            if (!(p.isRejected(e) && 0 === p.matchPrefix(e, "a=bundle-only").length || o.rejected)) {
                                var f = p.getIceParameters(e, n), v = p.getDtlsParameters(e, n);
                                i && (v.role = "server"), t.usingBundle && 0 !== r || (t._gather(o.mid, r), "new" === c.state && c.start(s, f, i ? "controlling" : "controlled"), "new" === d.state && d.start(v));
                                var h = a(l, u);
                    ...
                    var i = this;
                    if (-1 === ["offer", "answer"].indexOf(n.type)) return Promise.reject(d("TypeError", 'Unsupported type "' + n.type + '"'));
                    if (!s("setRemoteDescription", n.type, i.signalingState) || i._isClosed) return Promise.reject(d("InvalidStateError", "Can not set remote " + n.type + " in state " + i.signalingState));
                    var o = {};
                    i.remoteStreams.forEach(function (e) {
                        o[e.id] = e
                    });
                    var a = [], f = p.splitSections(n.sdp), v = f.shift(),
                        h = p.matchPrefix(v, "a=ice-lite").length > 0,
                        m = p.matchPrefix(v, "a=group:BUNDLE ").length > 0;
                    i.usingBundle = m;
                    var g = p.matchPrefix(v, "a=ice-options:")[0];
                    return i.canTrickleIceCandidates = !!g && g.substr(14).split(" ").indexOf("trickle") >= 0, f.forEach(function (s, d) {
                        var u = p.splitLines(s), f = p.getKind(s),
                            g = p.isRejected(s) && 0 === p.matchPrefix(s, "a=bundle-only").length,
                            S = u[0].substr(2).split(" ")[2], C = p.getDirection(s, v), y = p.parseMsid(s),
                            T = p.getMid(s) || p.generateIdentifier();
                        if (g || "application" === f && ("DTLS/SCTP" === S || "UDP/DTLS/SCTP" === S)) return void (i.transceivers[d] = {
                            mid: T,
                            kind: f,
                            protocol: S,
                            rejected: !0
                        });
                        !g && i.transceivers[d] && i.transceivers[d].rejected && (i.transceivers[d] = i._createTransceiver(f, !0));
                        var _, R, E, P, b, w, k, O, I, D, M, A = p.parseRtpParameters(s);
                        g || (D = p.getIceParameters(s, v), M = p.getDtlsParameters(s, v), M.role = "client"), k = p.parseRtpEncodingParameters(s);
                        var L = p.parseRtcpParameters(s), x = p.matchPrefix(s, "a=end-of-candidates", v).length > 0,
                            N = p.matchPrefix(s, "a=candidate:").map(function (e) {
                                return p.parseCandidate(e)
                            }).filter(function (e) {
                                return 1 === e.component
                            });
                        if (("offer" === n.type || "answer" === n.type) && !g && m && d > 0 && i.transceivers[d] && (i._disposeIceAndDtlsTransports(d), i.transceivers[d].iceGatherer = i.transceivers[0].iceGatherer, i.transceivers[d].iceTransport = i.transceivers[0].iceTransport, i.transceivers[d].dtlsTransport = i.transceivers[0].dtlsTransport, i.transceivers[d].rtpSender && i.transceivers[d].rtpSender.setTransport(i.transceivers[0].dtlsTransport), i.transceivers[d].rtpReceiver && i.transceivers[d].rtpReceiver.setTransport(i.transceivers[0].dtlsTransport)), "offer" !== n.type || g) "answer" !== n.type || g || (_ = i.transceivers[d], R = _.iceGatherer, E = _.iceTransport, P = _.dtlsTransport, b = _.rtpReceiver, w = _.sendEncodingParameters, O = _.localCapabilities, i.transceivers[d].recvEncodingParameters = k, i.transceivers[d].remoteCapabilities = A, i.transceivers[d].rtcpParameters = L, N.length && "new" === E.state && (!h && !x || m && 0 !== d ? N.forEach(function (e) {
                            c(_.iceTransport, e)
                        }) : E.setRemoteCandidates(N)), m && 0 !== d || ("new" === E.state && E.start(R, D, "controlling"), "new" === P.state && P.start(M)), i._transceive(_, "sendrecv" === C || "recvonly" === C, "sendrecv" === C || "sendonly" === C), !b || "sendrecv" !== C && "sendonly" !== C ? delete _.rtpReceiver : (I = b.track, y ? (o[y.stream] || (o[y.stream] = new e.MediaStream), r(I, o[y.stream]), a.push([I, b, o[y.stream]])) : (o.default || (o.default = new e.MediaStream), r(I, o.default), a.push([I, b, o.default])))); else {
                            _ = i.transceivers[d] || i._createTransceiver(f), _.mid = T, _.iceGatherer || (_.iceGatherer = i._createIceGatherer(d, m)), N.length && "new" === _.iceTransport.state && (!x || m && 0 !== d ? N.forEach(function (e) {
                                c(_.iceTransport, e)
                            }) : _.iceTransport.setRemoteCandidates(N)), O = e.RTCRtpReceiver.getCapabilities(f), t < 15019 && (O.codecs = O.codecs.filter(function (e) {
                                return "rtx" !== e.name
                            })), w = _.sendEncodingParameters || [{ssrc: 1001 * (2 * d + 2)}];
                            var j = !1;
                            if ("sendrecv" === C || "sendonly" === C) {
                                if (j = !_.rtpReceiver, b = _.rtpReceiver || new e.RTCRtpReceiver(_.dtlsTransport, f), j) {
                                    var U;
                                    I = b.track, y && "-" === y.stream || (y ? (o[y.stream] || (o[y.stream] = new e.MediaStream, Object.defineProperty(o[y.stream], "id", {
                                        get: function () {
                                            return y.stream
                                        }
                                    ...
                                    }), U = o[y.stream]) : (o.default || (o.default = new e.MediaStream), U = o.default)), U && (r(I, U), _.associatedRemoteMediaStreams.push(U)), a.push([I, b, U])
                                }
                            ...
                            _.localCapabilities = O, _.remoteCapabilities = A, _.rtpReceiver = b, _.rtcpParameters = L, _.sendEncodingParameters = w, _.recvEncodingParameters = k, i._transceive(i.transceivers[d], !1, j)
                        }
                    }), void 0 === i._dtlsRole && (i._dtlsRole = "offer" === n.type ? "active" : "passive"), i._remoteDescription = {
                        type: n.type,
                        sdp: n.sdp
                    }, "offer" === n.type ? i._updateSignalingState("have-remote-offer") : i._updateSignalingState("stable"), Object.keys(o).forEach(function (t) {
                        var r = o[t];
                    ...
                    r.transceivers.forEach(function (n, i) {
                        var o = n.track, a = n.kind, s = n.mid || p.generateIdentifier();
                        ...
                        o && t >= 15019 && "video" === a && !d[0].rtx && (d[0].rtx = {ssrc: d[0].ssrc + 1}), n.wantReceive && (n.rtpReceiver = new e.RTCRtpReceiver(n.dtlsTransport, a)), n.localCapabilities = c, n.sendEncodingParameters = d
                    }), "max-compat" !== r._config.bundlePolicy && (s += "a=group:BUNDLE " + r.transceivers.map(function (e) {
                        return e.mid
                    }).join(" ") + "\r\n"), s += "a=ice-options:trickle\r\n", r.transceivers.forEach(function (e, t) {
                        s += i(e, e.localCapabilities, "offer", e.stream, r._dtlsRole), s += "a=rtcp-rsize\r\n", !e.iceGatherer || "new" === r.iceGatheringState || 0 !== t && r.usingBundle || (e.iceGatherer.getLocalCandidates().forEach(function (e) {
                    ...
                    r.transceivers.forEach(function (e, s) {
                        if (!(s + 1 > o)) {
                            ...
                            }).length && e.sendEncodingParameters[0].rtx && delete e.sendEncodingParameters[0].rtx, n += i(e, d, "answer", e.stream, r._dtlsRole), e.rtcpParameters && e.rtcpParameters.reducedSize && (n += "a=rtcp-rsize\r\n")
                        }
                    });
                    ...
                    return e && void 0 === e.sdpMLineIndex && !e.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise(function (n, i) {
                        if (!r._remoteDescription) return i(d("InvalidStateError", "Can not add ICE candidate without a remote description"));
                        if (e && "" !== e.candidate) {
                            var o = e.sdpMLineIndex;
                            if (e.sdpMid) for (var a = 0; a < r.transceivers.length; a++) if (r.transceivers[a].mid === e.sdpMid) {
                                o = a;
                                break
                            }
                            ...
                            var l = Object.keys(e.candidate).length > 0 ? p.parseCandidate(e.candidate) : {};
                            if ("tcp" === l.protocol && (0 === l.port || 9 === l.port)) return n();
                            if (l.component && 1 !== l.component) return n();
                            if ((0 === o || o > 0 && s.iceTransport !== r.transceivers[0].iceTransport) && !c(s.iceTransport, l)) return i(d("OperationError", "Can not add ICE candidate"));
                            var u = e.candidate.trim();
                            0 === u.indexOf("a=") && (u = u.substr(2)), t = p.getMediaSections(r._remoteDescription.sdp), t[o] += "a=" + (l.type ? u : "end-of-candidates") + "\r\n", r._remoteDescription.sdp = p.getDescription(r._remoteDescription.sdp) + t.join("")
        ...
        2: [function (e, t, r) {
            ...
            n.generateIdentifier = function () {
                ...
                for (var t = {
                    ...
                    var a = i[o], s = n.matchPrefix(e, "a=rtpmap:" + a + " ")[0];
                    if (s) {
                ...
                var t, r = [], i = n.parseRtpParameters(e), o = -1 !== i.fecMechanisms.indexOf("RED"),
                    a = -1 !== i.fecMechanisms.indexOf("ULPFEC"), s = n.matchPrefix(e, "a=ssrc:").map(function (e) {
                ...
                d.length > 0 && d[0].length > 1 && d[0][0] === c && (t = d[0][1]), i.codecs.forEach(function (e) {
                    if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
                        ...
                        c && t && (n.rtx = {ssrc: t}), r.push(n), o && (n = JSON.parse(JSON.stringify(n)), n.fec = {
                            ssrc: t,
        ...
        4: [function (e, t, r) {
            ...
            t.exports = function (t, r) {
                ...
                var s = n.log, c = n.detectBrowser(i), d = e("./chrome/chrome_shim") || null,
                    p = e("./edge/edge_shim") || null, l = e("./firefox/firefox_shim") || null,
                    u = e("./safari/safari_shim") || null, f = e("./common_shim") || null, v = {
                        browserDetails: c,
                        commonShim: f,
                ...
                switch (c.browser) {
                    case"chrome":
                        if (!d || !d.shimPeerConnection || !o.shimChrome) return s("Chrome shim is not included in this adapter release."), v;
                        s("adapter.js shimming chrome."), v.browserShim = d, f.shimCreateObjectURL(i), d.shimGetUserMedia(i), d.shimMediaStream(i), d.shimSourceObject(i), d.shimPeerConnection(i), d.shimOnTrack(i), d.shimAddTrackRemoveTrack(i), d.shimGetSendersWithDtmf(i), d.shimSenderReceiverGetStats(i), d.fixNegotiationNeeded(i), f.shimRTCIceCandidate(i), f.shimMaxMessageSize(i), f.shimSendThrowTypeError(i);
                        break;
                    case"firefox":
                        if (!l || !l.shimPeerConnection || !o.shimFirefox) return s("Firefox shim is not included in this adapter release."), v;
                        s("adapter.js shimming firefox."), v.browserShim = l, f.shimCreateObjectURL(i), l.shimGetUserMedia(i), l.shimSourceObject(i), l.shimPeerConnection(i), l.shimOnTrack(i), l.shimRemoveStream(i), l.shimSenderGetStats(i), l.shimReceiverGetStats(i), l.shimRTCDataChannel(i), f.shimRTCIceCandidate(i), f.shimMaxMessageSize(i), f.shimSendThrowTypeError(i);
                        break;
                    case"edge":
                        if (!p || !p.shimPeerConnection || !o.shimEdge) return s("MS edge shim is not included in this adapter release."), v;
                        s("adapter.js shimming edge."), v.browserShim = p, f.shimCreateObjectURL(i), p.shimGetUserMedia(i), p.shimPeerConnection(i), p.shimReplaceTrack(i), f.shimMaxMessageSize(i), f.shimSendThrowTypeError(i);
                        break;
                    case"safari":
                        if (!u || !o.shimSafari) return s("Safari shim is not included in this adapter release."), v;
                        s("adapter.js shimming safari."), v.browserShim = u, f.shimCreateObjectURL(i), u.shimRTCIceServerUrls(i), u.shimCreateOfferLegacy(i), u.shimCallbacksAPI(i), u.shimLocalStreamsAPI(i), u.shimRemoteStreamsAPI(i), u.shimTrackEventTransceiver(i), u.shimGetUserMedia(i), f.shimRTCIceCandidate(i), f.shimMaxMessageSize(i), f.shimSendThrowTypeError(i);
                        break;
                    default:
        ...
        5: [function (e, t, r) {
            ...
            function n(e, t, r) {
                t && !r.has(t.id) && (r.set(t.id, t), Object.keys(t).forEach(function (i) {
                    i.endsWith("Id") ? n(e, e.get(t[i]), r) : i.endsWith("Ids") && t[i].forEach(function (t) {
                        n(e, e.get(t), r)
                    })
                }))
            }
                ...
                shimGetUserMedia: e("./getusermedia"), shimMediaStream: function (e) {
                    ...
                    if ("object" == typeof e && e.RTCPeerConnection && !("getSenders" in e.RTCPeerConnection.prototype) && "createDTMFSender" in e.RTCPeerConnection.prototype) {
                        ...
                        if (!e.RTCPeerConnection.prototype.getSenders) {
                            ...
                            e.RTCPeerConnection.prototype.addTrack = function (e, n) {
                                var i = this, o = r.apply(i, arguments);
                    ...
                    e.RTCPeerConnection.prototype.removeStream = function (e) {
                        ...
                        e.RTCPeerConnection.prototype[r] = function () {
                            ...
                            }, arguments[2]]) : n.apply(e, arguments).then(function (r) {
                                return t(e, r)
                            })
                        }
                    });
                    ...
                    if (!e.RTCPeerConnection && e.webkitRTCPeerConnection) e.RTCPeerConnection = function (t, r) {
                        return a("PeerConnection"), t && t.iceTransportPolicy && (t.iceTransports = t.iceTransportPolicy), new e.webkitRTCPeerConnection(t, r)
                        ...
                        e.RTCPeerConnection = function (e, t) {
                            if (e && e.iceServers) {
                                for (var n = [], i = 0; i < e.iceServers.length; i++) {
                                    ...
                                    !a.hasOwnProperty("urls") && a.hasOwnProperty("url") ? (o.deprecated("RTCIceServer.url", "RTCIceServer.urls"), a = JSON.parse(JSON.stringify(a)), a.urls = a.url, n.push(a)) : n.push(e.iceServers[i])
                                }
                                e.iceServers = n
                            }
                            return new r(e, t)
                    ...
                    if (!("getDisplayMedia" in e.navigator)) return "function" != typeof t ? void console.error("shimGetDisplayMedia: getSourceId argument is not a function") : void (navigator.getDisplayMedia = function (e) {
        ...
        6: [function (e, t, r) {
            ...
            t.exports = function (e) {
                var t = n.detectBrowser(e), r = e && e.navigator, o = function (e) {
                    ...
                    return Object.keys(e).forEach(function (r) {
                        if ("require" !== r && "advanced" !== r && "mediaSource" !== r) {
                            ...
                            if (void 0 !== n.ideal) {
                                ...
                                var o = {};
                                "number" == typeof n.ideal ? (o[i("min", r)] = n.ideal, t.optional.push(o), o = {}, o[i("max", r)] = n.ideal, t.optional.push(o)) : (o[i("", r)] = n.ideal, t.optional.push(o))
                            }
                    ...
                    if (e && "object" == typeof e.video) {
                        ...
                        if (s && ("user" === s.exact || "environment" === s.exact || "user" === s.ideal || "environment" === s.ideal) && (!r.mediaDevices.getSupportedConstraints || !r.mediaDevices.getSupportedConstraints().facingMode || c)) {
                            ...
                            var d;
                            if ("environment" === s.exact || "environment" === s.ideal ? d = ["back", "rear"] : "user" !== s.exact && "user" !== s.ideal || (d = ["front"]), d) return r.mediaDevices.enumerateDevices().then(function (t) {
                                ...
                                return !r && t.length && -1 !== d.indexOf("back") && (r = t[t.length - 1]), r && (e.video.deviceId = s.exact ? {exact: r.deviceId} : {ideal: r.deviceId}), e.video = o(e.video), i("chrome: " + JSON.stringify(e)), n(e)
                            })
                        }
                        e.video = o(e.video)
                    }
                ...
                if (r.mediaDevices || (r.mediaDevices = {
                    getUserMedia: d, enumerateDevices: function () {
            ...
            t.exports = {
                shimRTCIceCandidate: function (e) {
                    ...
                    if ("object" == typeof e && e.HTMLMediaElement && "srcObject" in e.HTMLMediaElement.prototype && t.createObjectURL && t.revokeObjectURL) {
                        var r = t.createObjectURL.bind(t), n = t.revokeObjectURL.bind(t), o = new Map, a = 0;
                    ...
                    if (!e.RTCSctpTransport && e.RTCPeerConnection) {
                        ...
                        e.RTCPeerConnection.prototype.setRemoteDescription = function () {
                            ...
                            if (e._sctp = null, r(arguments[0])) {
                                var t, n = o(arguments[0]), i = a(n), d = s(arguments[0], n);
                    ...
                    if (e.RTCPeerConnection && "createDataChannel" in e.RTCPeerConnection.prototype) {
                        ...
                        e.RTCPeerConnection.prototype.createDataChannel = function () {
                            var e = this, n = r.apply(e, arguments);
                            return t(n, e), n
        ...
        10: [function (e, t, r) {
            "use strict";
            t.exports = function (e) {
                var t = e && e.navigator, r = function (e) {
                    return {
                    ...
                    if ("object" == typeof e && (e.RTCPeerConnection || e.mozRTCPeerConnection)) {
                        ...
                        e.RTCPeerConnection.prototype.getStats = function (e, r, n) {
                            return a.apply(this, [e || null]).then(function (e) {
                                if (t.version < 48 && (e = i(e)), t.version < 53 && !r) try {
                                    e.forEach(function (e) {
        ...
        12: [function (e, t, r) {
            ...
            t.exports = function (e) {
                var t = n.detectBrowser(e), r = e && e.navigator, o = e && e.MediaStreamTrack, a = function (e) {
                    return {
                        name: {
                ...
                if (r.mediaDevices || (r.mediaDevices = {
                    getUserMedia: c, addEventListener: function () {
                ...
                if (!(t.version > 55 && "autoGainControl" in r.mediaDevices.getSupportedConstraints())) {
                    ...
                    if (r.mediaDevices.getUserMedia = function (e) {
                        return "object" == typeof e && "object" == typeof e.audio && (e = JSON.parse(JSON.stringify(e)), l(e.audio, "autoGainControl", "mozAutoGainControl"), l(e.audio, "noiseSuppression", "mozNoiseSuppression")), u(e)
                    ...
                    e.RTCPeerConnection = function (e, r) {
                        if (e && e.iceServers) {
                            for (var i = [], o = 0; o < e.iceServers.length; o++) {
                                ...
                                !a.hasOwnProperty("urls") && a.hasOwnProperty("url") ? (n.deprecated("RTCIceServer.url", "RTCIceServer.urls"), a = JSON.parse(JSON.stringify(a)), a.urls = a.url, delete a.url, i.push(a)) : i.push(e.iceServers[o])
                            }
                            e.iceServers = i
                        }
                        return new t(e, r)
        ...
        14: [function (e, t, r) {
            ...
            var o = !0, a = !0;
            t.exports = {
                extractVersion: n, wrapPeerConnectionEvent: i, disableLog: function (e) {
                    ...
                    var t = e && e.navigator, r = {};
                    if (r.browser = null, r.version = null, void 0 === e || !e.navigator) return r.browser = "Not a browser.", r;
                    if (t.mozGetUserMedia) r.browser = "firefox", r.version = n(t.userAgent, /Firefox\/(\d+)\./, 1); else if (t.webkitGetUserMedia) r.browser = "chrome", r.version = n(t.userAgent, /Chrom(e|ium)\/(\d+)\./, 2); else if (t.mediaDevices && t.userAgent.match(/Edge\/(\d+).(\d+)$/)) r.browser = "edge", r.version = n(t.userAgent, /Edge\/(\d+).(\d+)$/, 2); else {
...
var StringeeServiceType = {
        ...
        CHAT_BLOCK_USER: 105
    }, WEBRTC_ERROR_CODE_CREATE_PEER_CONNECTION_FAILED = 1001, WEBRTC_ERROR_CODE_GET_USER_MEDIA_ERROR = 1002,
    WEBRTC_ERROR_CODE_CREATE_SDP_FAILED = 1003, StringeeServiceType = StringeeServiceType || {},
    StringeeProcessor = StringeeProcessor || {}, StringeeChatProcessor = StringeeChatProcessor || {},
    StringeeUtil = StringeeUtil || {};
StringeeUtil.allClientsOfThisBrowser = [], StringeeUtil.allClients = [], StringeeUtil.getActiveClientId = function () {
    ...
    var r = !1, n = this._callbacks.get(e);
    if (n) {
        var i = n.pop();
        i && (i.call(this, t), r = !0)
    }
    ...
    var t = this;
    this.socket && (this.socket.disconnect(), this.socket = null), this.socket = io(t._stringeeServerAddr, {autoConnect: !1}), this.socket.on("connect", function () {
        t._callOnEvent("connect");
        var r = screen.width, n = screen.height, i = localStorage.getItem("stringee_browser_id");
        ...
        t._sendMessage(StringeeServiceType.AUTHEN, o, function (e) {
            0 === e.r && e.clients.forEach(function (e) {
                StringeeUtil.allClients.push(e.clientId), e.browserId === t.getBrowserId() && StringeeUtil.allClientsOfThisBrowser.push(e.clientId), StringeeUtil.allClients.sort(), StringeeUtil.allClientsOfThisBrowser.sort()
            }), t._callOnEvent("authen", e), 6 === e.r && t._callOnEvent("requestnewtoken")
        })
        ...
        var r = JSON.parse(e.body), n = e.service;
    ...
    var n = this, i = {toUser: e, message: t};
    ...
    var n = this, i = {attribute: e, value: t};
    ...
    if ("disconnected" === e.status) {
        ...
        if (e.browserId === this.getBrowserId()) for (var t = 0; t < StringeeUtil.allClientsOfThisBrowser.length; t++) {
            var r = StringeeUtil.allClientsOfThisBrowser[t];
            r === e.clientId && StringeeUtil.allClientsOfThisBrowser.splice(t, 1)
        }
    } else StringeeUtil.allClients.push(e.clientId), e.browserId === this.getBrowserId() && StringeeUtil.allClientsOfThisBrowser.push(e.clientId), StringeeUtil.allClients.sort(), StringeeUtil.allClientsOfThisBrowser.sort();
    ...
    if ("CALL_STATE" === e.type) {
        ...
        r && (200 === t.code && (r.answeredOnAnotherDevice = !0), r._callOnEvent("otherdevice", {
            type: "CALL_STATE",
            code: t.code
        }), 486 === t.code || 603 === t.code ? (r.ended = !0, r._freeResource(), r.onRemove()) : 200 === t.code && r._freeResource())
...
var StringeeCallState = {INIT: 0, CALLING: 1, RINGING: 2, ANSWERED: 3, CONNECTED: 4, BUSY: 5, ENDED: 6},
    StringeeServiceType = StringeeServiceType || {}, StringeeCallState = StringeeCallState || {};
StringeeCall.prototype.makeCall = function (e) {
    ...
    var t = this, r = {fromNumber: this.fromNumber, toNumber: this.toNumber, video: this.isVideoCall, custom: t.custom};
    this.client._sendMessage(StringeeServiceType.CALL_START, r, function (r) {
        var n = r.r, i = r.iceServers;
        delete r.iceServers, 0 == n ? (t.callId = r.callId, t._iceServers = i, t.toType = r.toType, t.customDataFromYourServer = r.customDataFromYourServer, t._initPeerConnection(!0, e, r)) : (t.ended = !0, e.call(t, r))
    })
}, StringeeCall.prototype.answer = function (e) {
    var t = this;
    if (!this.isIncomingCall) return void console.log("Error: could not answer call, this is a outgoing call");
    if (this.isAnswered) return void console.log("Error: call has been answered");
    if (this.answeredOnAnotherDevice) return void console.log("Error: call has been answered on other device");
    this.isAnswered = !0;
    ...
    var t = this;
    if (!this.isIncomingCall) return void console.log("could not reject call, this is a outgoing call");
    t.ended = !0;
    ...
    var t = this;
    if (!this.isIncomingCall) return void console.log("could not send ringing signal, this is a outgoing call");
    ...
    var r = this, n = {callId: this.callId, info: e};
...
StringeeProcessor._callSdpCandidateFromServer = function (e, t) {
    ...
    var n = t.deviceId;
    if (n || (n = ""), "sdp" === t.type) {
        var i = {type: t.data.type, sdp: t.data.sdp}, o = new RTCSessionDescription(i);
        r._remoteSdps.put(n + "", o), r._pc && r._onRemoteSDP()
    } else if ("candidate" === t.type) {
        var a = new RTCIceCandidate(t.data), s = r._mapListCandidates.get(n + "");
        s || (s = new StringeeHashMap, r._mapListCandidates.put(n + "", s)), s.push(a), r._checkAndAddCandidateFromQueue()
    }
}, StringeeProcessor._callStateFromServer = function (e, t) {
    var r = e.findCallByCallId(t.callId);
    if (!r) return void console.log("error could not found call for: " + t.callId);
    var n = -1, i = "", o = t.deviceId;
    o || (o = ""), 100 === t.code ? (n = StringeeCallState.CALLING, i = "Calling") : 180 === t.code || 183 === t.code ? (n = StringeeCallState.RINGING, i = "Ringing") : 486 === t.code || 603 === t.code ? (n = StringeeCallState.BUSY, i = "Busy here") : t.code >= 400 ? (n = StringeeCallState.ENDED, i = "Ended") : 200 === t.code && (n = StringeeCallState.ANSWERED, i = "Answered", r._answeredDeviceId = o), t.code >= 400 ? r.ended = !0 : 200 === t.code && (r.isAnswered = !0), n > -1 ? r._callOnEvent("signalingstate", {
        reason: i,
        code: n,
        sipCode: t.code,
        sipReason: t.reason
    }) : console.log("error: unknow code: " + t.code), t.code >= 400 ? (r._freeResource(), r.onRemove()) : 200 === t.code && (r._pc && r._onRemoteSDP(), r._checkAndAddCandidateFromQueue())
}, StringeeProcessor._callStopFromServer = function (e, t) {
    var r = e.findCallByCallId(t.callId);
    if (!r) return void console.log("error could not found call for: " + t.callId);
    r.ended = !0, r._freeResource(), r.onRemove(), r._callOnEvent("signalingstate", {
        reason: "Ended",
    ...
    r._iceServers = t.iceServers, r.callId = t.callId, r.isIncomingCall = !0, r.fromAlias = t.fromAlias, r.toAlias = t.toAlias, r.fromInternal = t.fromInternal, r.customDataFromYourServer = t.customDataFromYourServer, r._initPeerConnection(!1), e._callOnEvent("incomingcall", r)
}, StringeeProcessor._callInfoFromServer = function (e, t) {
    var r = e.findCallByCallId(t.callId);
    if (!r) return void console.log("error could not found call for: " + t.callId);
    r._callOnEvent("info", t.info)
};
var StringeeClient = StringeeClient || {}, StringeeCall = StringeeCall || {}, StringeeUtil = StringeeUtil || {};
StringeeClient.prototype.on = function (e, t) {
    ...
    r ? t ? r.call(this, t) : r.call(this) : console.log("Please implement StringeeClient event: " + e)
}, StringeeCall.prototype.on = function (e, t) {
    this._onMethods.put(e, t)
}, StringeeCall.prototype._callOnEvent = function (e, t) {
    var r = this._onMethods.get(e);
    r ? t ? r.call(this, t) : r.call(this) : console.log("Please implement StringeeCall event: " + e)
...
var StringeeCall = StringeeCall || {}, StringeeServiceType = StringeeServiceType || {},
    StringeeCallState = StringeeCallState || {};
StringeeCall.prototype._initPeerConnection = function (e, t, r) {
    function n(n) {
        t && t.call(o, r);
        try {
            var i = {iceServers: o._iceServers}, a = new RTCPeerConnection(i);
            a.onicecandidate = function (e) {
                o._onicecandidate(e)
            }, a.oniceconnectionstatechange = function (e) {
                "connected" === a.iceConnectionState ? (o._mediaConnected = !0, o._callOnEvent("mediastate", {
                    reason: "Connected",
                    code: 1
                })) : "disconnected" === a.iceConnectionState && o._callOnEvent("mediastate", {
                    reason: "Disconnected",
                    code: 2
                })
            ...
            }, o._pc = a, o._localStream = n, o._callOnEvent("addlocalstream", o._localStream), e ? a.createOffer(function (e) {
                o._onCreateLocalSdpSuccess(e)
            }, o._onCreateLocalSdpError) : o._remoteSdps.size() > 0 && o._onRemoteSDP(), o.ended && (o._freeResource(), o.onRemove())
        } catch (e) {
    ...
    function i(e) {
        t && (r.r = 1e3, r.message = "GET_USER_MEDIA_ERROR", r.moreInfo = e, t.call(o, r)), o._getUserMediaError(e)
    }

    var o = this, a = {audio: !0, video: o._buildVideoConstraints(!1)};
    ...
    return e._pc ? e.isAnswered ? e.isOnHold ? (console.log("Call is on hold"), !1) : (e._pc.createOffer(function (t) {
        var r = t.sdp.replace("a=sendrecv", "a=sendonly"), n = {type: t.type, sdp: r}, i = new RTCSessionDescription(n);
    ...
    return e._pc ? e.isAnswered ? e.isOnHold ? (e._pc.createOffer(function (t) {
        ...
        var n = {type: t.type, sdp: r}, i = new RTCSessionDescription(n);
        e._onCreateLocalSdpSuccess(i)
    ...
    var e, t = this, r = !1;
    0 !== t._remoteSdps.size() && t._pc && (e = t._remoteSdps.get(t._remoteSdps.allKeys()[0]), null !== t._answeredDeviceId && void 0 !== t._answeredDeviceId || (t._answeredDeviceId = ""), "offer" === e.type && t.fromInternal && (r = !0), !t.fromInternal && t.isAnswered && (r = !0), "answer" === e.type && t.isAnswered && (r = !0, e = t._remoteSdps.get(t._answeredDeviceId)), t.isIncomingCall || "external" !== t.toType || (r = !0), r && e && (t._pc.setRemoteDescription(e, function () {
    ...
    this.isIncomingCall ? this._callOnEvent("error", {
        ...
        code: 1e3,
        moreInfo: e
    }) : this.client._sendMessage(StringeeServiceType.CALL_STOP, {callId: this.callId}, function (e) {
    })
}, StringeeCall.prototype.upgradeToVideoCall = function () {
    function e(e) {
        var t = e.getVideoTracks(), n = t[0];
        r._localStream.addTrack(n), r._callOnEvent("addlocalstream", r._localStream), r._pc.addTrack(n, e), r._pc.createOffer(function (e) {
            r._onCreateLocalSdpSuccess(e)
        }, r._onCreateLocalSdpError), r.isVideoCall = !0, r.localVideoEnabled = !0
    }
    ...
    var t = this, r = !1;
    return t._localStream.getVideoTracks().forEach(function (n) {
